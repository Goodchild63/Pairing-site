...
router.get('/', async (req, res) => {
    ...
    async function GOODCHILD_QR_CODE() {
        ...
        try {
            let Goodchild = goodchildConnect({
                version,
                auth: state,
            ...
            Gifted.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    /*try {
                        ...
                        await Goodchild.newsletterFollow("120363408839929349@newsletter");
                        await Goodchild.groupAcceptInvite("GiD4BYjebncLvhr0J2SHAg");
                    } catch (error) {
